...
- **With file argument**: open the specified `chibiforge.xcfg` and load its configuration.
- **Without file argument**: show a welcome screen with:
  - Recent files list.
  - "Open" button.
